    ...
    methods: {
                ...
                let notificationRes = await wx.cloud.callFunction({
                    ...
                    data: {
                        ...
                        url:
                            ...
                            this.data.chatRoomGroupId +
                            "&name=" +
                            this.data.chatRoomGroupName +
                            "&haoyou_openid=" +
                            this.data.haoyou_openid,
        ...
        async sendrecord(e) {
            ...
            const uploadTask = wx.cloud.uploadFile({
                cloudPath: `录音/${this.data.groupId}/${this.data.userInfo.nickName}/${Math.random()}_${Date.now()}.${
                    this.data.tempFilePathrecord.match(/\.(\w+)$/)[1]
                }`,
        ...
        async file(e) {
            wx.chooseMessageFile({
                ...
                success: async (res) => {
                    ...
                    const uploadTask = wx.cloud.uploadFile({
                        cloudPath: `文件传输/${this.data.groupId}/${this.data.userInfo.nickName}/${Math.random()}_${Date.now()}.${
                            res.tempFiles[0].path.match(/\.(\w+)$/)[1]
                        }`,
        ...
        async onChooseImage(e) {
            wx.chooseImage({
                ...
                success: async (res) => {
                    ...
                    const uploadTask = wx.cloud.uploadFile({
                        cloudPath: `办公交流/${this.data.groupId}/${this.data.userInfo.nickName}/${Math.random()}_${Date.now()}.${
